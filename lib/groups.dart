...
class _QuoteScreenState extends State<Groups> {
  var mypcat;

  Future ptest(String pcat) async {
    var box = Hive.box("icousel");
    var userid = box.get("userid");
    var userlink = "https://icounselgh.net/groups";
  ...
  void myCall() async {
    ...
    if (repo == "pending") {
      ...
      SweetAlert.show(
                              context,
                              title: "Congrats!!",
                              subtitle: '\t\t\tYour request is approved. \n\t\t\tYou will be added to the selected group \n\t\t\tif not done yet.',
  ...
  void myCall2()async{
    setState(() {
                            mypcat = "Help for Sexual Minority ";
                          });
                          SweetAlert.show(
                            context,
                            title: "Loading ..",
                    ...
                    children: [
                      _homeCard(
                        ...
                        onTap: () async {
                          ...
                          SweetAlert.show(context,
                              subtitle:
                                  "\t\t\tAre you going through any form of \n\t\t\taddiction? Could it be drugs, \n\t\t\talcohol, sex, food and more. \n\t\t\tJoin this group for help.",
                      ...
                      _homeCard(
                        ...
                        onTap: () async {
                          SweetAlert.show(context,
                              subtitle:
                                  "\t\t\tAre you 18+? Do you want to make \n\t\t\tthe best choice in your relationship \n\t\t\tand marriage? Then join this group.",
                              style: SweetAlertStyle.confirm,
                              showCancelButton: true,
                              onPress: (bool isConfirm) {
                            if (isConfirm) {
                      ...
                      _homeCard(
                        ...
                        onTap: () async {
                          SweetAlert.show(context,
                              subtitle:
                                  "\t\t\tDo you have any challenge with your \n\t\t\tsexuality?  Thus, homosexuality, \n\t\t\ttransgender,  and more? \n\t\t\tDo you need counselling \n\t\t\tto overcome any of these \n\t\t\tissues without feeling stigmatised? \n\t\t\tThen join this group for help.",
                              style: SweetAlertStyle.confirm,
                              showCancelButton: true,
                              onPress: (bool isConfirm) {
                            if (isConfirm) {
                      ...
                      _homeCard(
                        ...
                        onTap: () async {
                          ...
                          SweetAlert.show(context,
                              subtitle: "\t\t\tStaying unemployed is a serious \n\t\t\tcontributor to mental health \n\t\t\tchallenges. \n\t\t\tSeek counselling to overcome \n\t\t\tthis challenge.\n\t\t\tJoin this group now",
                              style: SweetAlertStyle.confirm,
                              showCancelButton: true,
                              onPress: (bool isConfirm) {
                            if (isConfirm) {
